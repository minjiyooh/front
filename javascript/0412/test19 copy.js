...
function regexCheck() {
    ...
    const regex24 = /\w/g;      // /영문자/숫자를 포함하고 있지 않느냐?
    const regex25 = /\w/g;      // /영문자/숫자를 포함하고 있지 않느냐?
    const regex25 = /\s/g;      // /문장안에 공백(탭포함)을 포함하고 있느냐?
    ...
    // if (regex23.test(content)) alert("영문/숫자/밑줄(_)을 포함하고 있습니다.");
